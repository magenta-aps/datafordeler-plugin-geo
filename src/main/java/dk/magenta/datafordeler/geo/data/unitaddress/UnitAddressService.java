...
public class UnitAddressService extends FapiBaseService<UnitAddressEntity, UnitAddressQuery> {
    ...
    @Override
    protected void sendAsCSV(Stream<UnitAddressEntity> stream, HttpServletRequest httpServletRequest, HttpServletResponse httpServletResponse) throws IOException, HttpNotFoundException {

    }

    @Override
    protected void applyAreaRestrictionsToQuery(UnitAddressQuery query, DafoUserDetails user) throws InvalidClientInputException {
